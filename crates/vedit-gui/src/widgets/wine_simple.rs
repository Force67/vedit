...
pub fn render_wine_panel() -> Element<'static, Message> {
    let content = column![
        ...
        .spacing(10),
        // Placeholder content
        text("No Wine environments created yet").color(iced::Color::from_rgb(0.7, 0.7, 0.7)),
        ...
        .spacing(10),
        text("No processes running").color(iced::Color::from_rgb(0.7, 0.7, 0.7)),
        iced::widget::Space::new().height(Length::Fixed(20.0)),
        // Settings section
        row![
        ...
        column![
            row![
                fa_icon_solid("check-circle")
                    .size(14.0)
                    .color(iced::Color::from_rgb(0.2, 0.8, 0.2)),
                text(" Wine Status: Available")
            ],
            row![
                fa_icon_solid("computer")
                    .size(14.0)
                    .color(iced::Color::WHITE),
                text(" System: Linux")
            ],
            row![
                fa_icon_solid("microchip")
                    .size(14.0)
                    .color(iced::Color::WHITE),
